...
// This component contains the protected layout with sidebar and header
...
// This is the root layout for the /admin-secret-sam01 section
export default function AdminLayout({ children }: { children: ReactNode }) {
  const pathname = usePathname();

  // The login page is not wrapped by the protected layout
  if (pathname === '/admin-secret-sam01/login') {
    return <>{children}</>;
  }

  // All other admin pages are wrapped by the protected layout
