...
export default function Footer() {
  return (
    <footer className="bg-primary-deeper text-primary-foreground">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="border-t border-primary-foreground/20 pt-8 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
